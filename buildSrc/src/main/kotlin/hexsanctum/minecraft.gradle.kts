...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexsanctum.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexsanctum-common-common-refmap.json
        // fixed:   hexsanctum-common.refmap.json
