...
abstract class HexsanctumModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexsanctumModDependenciesExtension>("hexsanctumModDependencies")
